 ...
 *        decided to rename value1_, or change its type? 
 *        We’d break not only this program, but likely most of the 
 *        programs that use class Something as well!
 *
 *        Encapsulation gives us the ability to change how classes are 
 *        implemented without breaking all of the programs that use them.
 *
